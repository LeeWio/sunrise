...
export const LineHeightPicker = React.memo(({ value, onChange, onClear, hasSeparator = true }: LineHeightPickerProps) => {
  return (
    <Dropdown>
      <Button size="sm" variant="tertiary">
        {hasSeparator && <ButtonGroup.Separator />}
        <ArrowsExpandVertical className="size-3 opacity-50" />
        {value || "1.15"}
