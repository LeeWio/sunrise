...
const FONT_FAMILIES = [
  ...
  { id: "Palatino", label: "Palatino", font: "'Palatino Linotype', 'Book Antiqua', Palatino, serif" },
  ...
  { id: "Impact", label: "Display", font: "Impact, Haettenschweiler, 'Arial Narrow Bold', sans-serif" },
];

export const FontFamilyPicker = React.memo(({ value, onChange, onClear }: FontFamilyPickerProps) => {
  return (
    <Dropdown>
