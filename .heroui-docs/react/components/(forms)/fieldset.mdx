...
function CustomFieldset() {
  return (
    <Fieldset className="border-border bg-surface rounded-xl border p-6 shadow-sm">
      ...
      <Fieldset.Group className="grid gap-4 md:grid-cols-2">
        <TextField>
          ...
          <Input className="border-border/60 rounded-full" placeholder="Jane" />
        </TextField>
        <TextField>
          <Label>Last name</Label>
          <Input className="border-border/60 rounded-full" placeholder="Doe" />
        </TextField>
      </Fieldset.Group>
      <Fieldset.Actions className="justify-end gap-3">{/* Action buttons */}</Fieldset.Actions>
    </Fieldset>
  );
}
```
...
@layer components {
  .fieldset {
    @apply border-border/60 bg-surface shadow-field gap-5 rounded-xl border p-6;
  }
