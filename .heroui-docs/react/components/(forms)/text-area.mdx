...
function CustomTextArea() {
  return (
    <div className="flex flex-col gap-2">
      ...
      <TextArea
        id="custom-textarea"
        className="border-border/70 bgsurface rounded-xl border px-4 py-3 text-sm leading-6 shadow-sm"
...
@layer components {
  .textarea {
    @apply border-border bgsurface rounded-xl border px-4 py-3 text-sm leading-6 shadow-sm;
