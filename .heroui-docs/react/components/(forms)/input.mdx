...
function CustomInput() {
  return (
    <div className="flex flex-col gap-2">
      ...
      <Input
        id="custom-input"
        className="border-border/70 bgsurface focus-visible:border-primary rounded-xl border px-4 py-2 text-sm shadow-sm"
...
@layer components {
  .input {
    @apply border-border bgsurface rounded-lg border px-4 py-2 text-sm shadow-sm transition-colors;
