...
function CustomComboBox() {
  return (
    <ComboBox className="w-full">
      ...
      <ComboBox.InputGroup className="bg-surface rounded-lg border p-2">
...
@layer components {
  ...
  .combo-box__trigger {
    @apply text-muted absolute right-0;
  }

  .combo-box__popover {
    @apply border-border bg-surface rounded-lg border p-2;
  }
}
```
...
function ControlledComboBox() {
  ...
  return (
    <ComboBox className="w-[256px]" selectedKey={selectedKey} onSelectionChange={setSelectedKey}>
      <Label>Animal</Label>
      <ComboBox.InputGroup>
        <Input placeholder="Search animals..." />
        <ComboBox.Trigger />
