...
function CustomLink() {
  return (
    <Link href="#" className="text-accent hover:text-accent/80 text-lg font-bold">
      Custom styled link
    </Link>
  );
}
...
export default function Demo() {
  return (
    <NextLink href="/about" className="link underline-offset-2 hover:underline">
      About Page
    </NextLink>
  );
}
...
export default function NativeLink() {
  return (
    <a href="/about" className="link decoration-primary underline underline-offset-4">
      About Page
