...
<span className="text-muted text-sm">Support Claude Code, Cursor, OpenCode and more.</span>
...
<Callout>
  For more complex use cases, use the [MCP Server](/docs/react/getting-started/mcp-server) which
  provides real-time access to component documentation and source code.
</Callout>
