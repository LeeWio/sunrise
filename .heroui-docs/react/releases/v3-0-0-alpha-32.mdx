...
<div className="mb-6 flex items-center gap-3">
  <span className="text-muted text-sm">October 1, 2025</span>
</div>
...
<div className="mb-4 flex items-center gap-3">
  <a
    ...
    className="button button--tertiary button--sm bg-default/50 dark:bg-default/30 no-underline"
  >
    <svg viewBox="0 0 466.73 532.09" className="h-5 w-5 fill-current">
