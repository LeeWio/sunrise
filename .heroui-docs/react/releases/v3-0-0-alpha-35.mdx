...
<div className="mb-6 flex items-center gap-3">
  <span className="text-muted text-sm">October 21, 2025</span>
</div>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">```bash npm i @heroui/styles@alpha @heroui/react@alpha ```</Tab>
  <Tab value="pnpm">```bash pnpm add @heroui/styles@alpha @heroui/react@alpha ```</Tab>
  <Tab value="yarn">```bash yarn add @heroui/styles@alpha @heroui/react@alpha ```</Tab>
  <Tab value="bun">```bash bun add @heroui/styles@alpha @heroui/react@alpha ```</Tab>
</Tabs>
