...
<div className="mb-6 flex items-center gap-3">
  <span className="text-muted text-sm">March 2026</span>
</div>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">```bash npm i @heroui/styles @heroui/react ```</Tab>
  <Tab value="pnpm">```bash pnpm add @heroui/styles @heroui/react ```</Tab>
  <Tab value="yarn">```bash yarn add @heroui/styles @heroui/react ```</Tab>
  <Tab value="bun">```bash bun add @heroui/styles @heroui/react ```</Tab>
</Tabs>
...
<Tabs items={["npm", "pnpm", "yarn", "bun"]}>
  <Tab value="npm">```bash npm install heroui-native ```</Tab>
  <Tab value="pnpm">```bash pnpm add heroui-native ```</Tab>
  <Tab value="yarn">```bash yarn add heroui-native ```</Tab>
  <Tab value="bun">```bash bun add heroui-native ```</Tab>
</Tabs>
